...
MATRIZ_REGLAS_CONCILIACION: tuple[ReglaConciliacionFiscal, ...] = (
    ReglaConciliacionFiscal(
        ...
        banco="Deposito directo en efectivo, ventanilla o concentracion bancaria.",
        metodo="Orden por sucursal, fecha/corte y forma de pago: factura de ingreso contra deposito bancario.",
        formas_pago=("01",),
        movimiento="abono",
        permite_match_directo=False,
        requiere_cfdi="emitido",
        requiere_evidencia="Factura de ingreso por sucursal, corte de caja, fecha de venta y ficha de deposito.",
        siguiente_revision="Comparar factura/corte de efectivo por sucursal contra depositos; explicar faltantes, sobrantes o depositos diferidos.",
        mesa_label="Efectivo",
        mesa_detalle="Ingreso facturado por sucursal; revisar bolsa/corte contra deposito.",
        tono="is-warn",
    ),
    ReglaConciliacionFiscal(
        codigo="TARJETA_TPV_NETO",
        flujo="Tarjetas: deposito neto",
        sat="CFDI de ingreso por sucursal con forma 04 Credito, 28 Debito o 29 Servicios.",
        banco="Depositos de adquirente, BanBajio negocios afiliados, OptBlue o American Express.",
        metodo="Orden por sucursal y terminal: ingreso bruto facturado contra deposito neto, comisiones, IVA y liquidacion del adquirente.",
        formas_pago=("04", "28", "29"),
        movimiento="abono",
        permite_match_directo=False,
        requiere_cfdi="emitido y recibido",
        requiere_evidencia="Factura de ingreso por sucursal, liquidacion del adquirente y CFDI recibido por comisiones.",
        siguiente_revision="Cruzar ingresos por tarjeta facturados por sucursal contra depositos netos y cargos de comision.",
        mesa_label="Tarjeta",
        mesa_detalle="Ingreso facturado por sucursal; revisar deposito neto mas comisiones.",
        tono="is-warn",
    ),
    ReglaConciliacionFiscal(
