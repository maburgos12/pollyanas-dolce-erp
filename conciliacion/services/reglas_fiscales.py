...
MATRIZ_REGLAS_CONCILIACION: tuple[ReglaConciliacionFiscal, ...] = (
    ReglaConciliacionFiscal(
        ...
        flujo="Efectivo por sucursal y día",
        sat="CFDI de ingreso emitido por sucursal con forma 01 Efectivo.",
        banco="Depósito directo en efectivo, ventanilla o concentración bancaria.",
        metodo="Orden por sucursal, fecha/corte y forma de pago: factura de ingreso contra depósito bancario.",
        formas_pago=("01",),
        movimiento="abono",
        permite_match_directo=False,
        requiere_cfdi="emitido",
        requiere_evidencia="Factura de ingreso por sucursal, corte de caja, fecha de venta y ficha de depósito.",
        siguiente_revision="Comparar factura/corte de efectivo por sucursal contra depósitos; explicar faltantes, sobrantes o depósitos diferidos.",
        mesa_label="Efectivo",
        mesa_detalle="Ingreso facturado por sucursal; revisar bolsa/corte contra depósito.",
        tono="is-warn",
    ),
    ReglaConciliacionFiscal(
        codigo="TARJETA_TPV_NETO",
        flujo="Tarjetas: depósito neto",
        sat="CFDI de ingreso por sucursal con forma 04 Crédito, 28 Débito o 29 Servicios.",
        banco="Depósitos de adquirente, BanBajío negocios afiliados, OptBlue o American Express.",
        metodo="Orden por sucursal y terminal: ingreso bruto facturado contra depósito neto, comisiones, IVA y liquidación del adquirente.",
        formas_pago=("04", "28", "29"),
        movimiento="abono",
        permite_match_directo=False,
        requiere_cfdi="emitido y recibido",
        requiere_evidencia="Factura de ingreso por sucursal, liquidación del adquirente y CFDI recibido por comisiones.",
        siguiente_revision="Cruzar ingresos por tarjeta facturados por sucursal contra depósitos netos y cargos de comisión.",
        mesa_label="Tarjeta",
        mesa_detalle="Ingreso facturado por sucursal; revisar depósito neto más comisiones.",
        tono="is-warn",
    ),
    ReglaConciliacionFiscal(
        codigo="TRANSFERENCIA_CLIENTE",
        flujo="Transferencia de cliente",
        sat="CFDI de ingreso con forma 03 Transferencia, o complemento de pago si la factura fue PPD.",
        banco="SPEI o transferencia recibida identificable por cliente.",
        metodo="Orden por sucursal/cliente: match por monto, fecha, RFC/cliente y referencia cuando exista.",
        formas_pago=("03",),
        movimiento="abono",
        permite_match_directo=True,
        requiere_cfdi="emitido o pago",
        requiere_evidencia="Factura de ingreso, referencia SPEI, cliente y sucursal cuando aplique.",
    ...
    ReglaConciliacionFiscal(
        ...
        requiere_evidencia="Factura recibida, comprobante bancario o autorización si no hay CFDI.",
    ...
    ReglaConciliacionFiscal(
        ...
        banco="Cargo por tasa de descuento, OptBlue, negocios afiliados o comisión TPV.",
        metodo="Relacionar comisión con liquidación de tarjeta y CFDI recibido.",
        formas_pago=(),
        movimiento="cargo",
        permite_match_directo=False,
        requiere_cfdi="recibido",
        requiere_evidencia="Liquidación del adquirente y factura de comisión.",
        siguiente_revision="Agrupar comisiones por día/adquirente y validar IVA acreditable.",
        mesa_label="Comisión TPV",
        mesa_detalle="Revisar liquidación y CFDI de comisión.",
        tono="is-warn",
    ),
    ReglaConciliacionFiscal(
        codigo="NOMINA_TIMBRADA",
        flujo="Nómina y dispersión",
        sat="CFDI de nómina timbrado por empleado y periodo.",
        banco="Dispersión de nómina, PTU, finiquito o transferencia a personal.",
        metodo="Cruzar dispersión contra nómina timbrada y recibos autorizados.",
        formas_pago=(),
        movimiento="cargo",
        permite_match_directo=False,
        requiere_cfdi="nomina",
        requiere_evidencia="Nómina timbrada, layout de dispersión y autorización.",
        siguiente_revision="Validar que la dispersión corresponde al periodo y empleados pagados.",
        mesa_label="Nómina",
        mesa_detalle="Revisar contra timbrado de nómina y dispersión.",
        tono="is-info",
    ),
    ReglaConciliacionFiscal(
        codigo="IMPUESTOS_DEVOLUCIONES",
        flujo="Impuestos y devoluciones SAT",
        sat="Línea de captura, declaración, opinión o resolución; normalmente no hay CFDI.",
        banco="Pago de impuestos, devolución SAT, recargos o actualizaciones.",
        metodo="Conciliación documental fiscal, separada de ventas y proveedores.",
        formas_pago=(),
        movimiento="ambos",
        permite_match_directo=False,
        requiere_cfdi="ninguno",
        requiere_evidencia="Declaración, acuse, línea de captura, resolución o devolución.",
    ...
    ReglaConciliacionFiscal(
        ...
        flujo="Traspasos, préstamos y balance",
        sat="No siempre genera CFDI; depende de naturaleza legal y fiscal.",
        banco="Traspaso entre cuentas, préstamo recibido, pago de préstamo o aportación.",
        metodo="Conciliación de balance con cuenta contraparte y soporte.",
        formas_pago=(),
        movimiento="ambos",
        permite_match_directo=False,
        requiere_cfdi="opcional",
        requiere_evidencia="Cuenta origen/destino, contrato, autorización o póliza contable.",
    ...
    ReglaConciliacionFiscal(
        ...
        sat="Requiere revisar forma/método de pago o naturaleza del movimiento.",
        banco="Descripción insuficiente para clasificar automáticamente.",
        metodo="Revisión manual antes de marcar conciliado.",
        formas_pago=(),
        movimiento="ambos",
        permite_match_directo=False,
        requiere_cfdi="por definir",
        requiere_evidencia="Descripción bancaria, cuenta, comprobante y criterio contable.",
