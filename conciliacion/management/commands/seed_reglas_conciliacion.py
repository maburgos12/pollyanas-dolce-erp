...
REGLAS = [
    ...
    ("Comisiones bancarias y de terminal", "COMISION_TPV", "cargo", 20,
     ["COMISION APLICACION DE TASAS", "COMISION APLICACION TASAS", "COMISION POR DEPOSITO",
      "COMISION ADMINISTRACION DE PAQUETE", "SERV BANCA INTERNET", "COMISION EMI"], 90),
    # --- Ingresos ---
    ...
    ("Traspasos Conecta BanBajio", "TRASPASO_ENTRE_CUENTAS", "ambos", 40,
     ["TRASPASO DE RECURSOS A LA CUENTA CONECTA", "TRASPASO DE RECURSOS DE LA CUENTA CONECTA",
      "TRASPASO DE RECURSOS A LA CUENTA DE CHEQUES", "TRASPASO DE RECURSOS DE LA CUENTA DE CHEQUES"], 90),
    ...
    ("Pago de nomina", "PAGO_NOMINA_TIMBRADA", "cargo", 60,
     ["PAGO DE NOMINA", "PAGO PRIMA VACACIONAL", "EDENRED", "INSTITUTO FONACOT",
      "TRASPASO PAGO NOMINA", "SPEI ENVIADO BANCOPPEL"], 85),
    # --- Gastos / proveedores ---
    ...
    ("Pago a proveedor por SPEI con factura", "PAGO_PROVEEDOR_CFDI", "cargo", 75,
     ["SPEI:FACT", "SPEIFACT", "SPEI:-FACT", "SPEI-FACT", "SPEL:FACT", "SPELFACT",
      "SPEL-FACT", "SPEI:PAGO", "SPEIPAGO", "SPEL:PAGO", "SPEI:NOTA", "SPEINOTA",
      "SPEL:NOTA", "SPEI:COTIZACION", "SPEL:COTIZACION", "SPEI:ENVIO", "SPEL:ENVIO",
      "PAGO DE SERVICIO", "RETIRO POR DOMICILIACION"], 80),
    ("Compra con tarjeta empresarial (POS)", "PAGO_PROVEEDOR_CFDI", "cargo", 80,
     ["COMPRA-DISPOSICION (POS)", "COMPRA-DISPOSICION"], 80),
    ("Transferencia recibida de cliente", "TRANSFERENCIA_CLIENTE_CFDI", "abono", 95,
     ["SPEI RECIBIDO", "DEPOSITO DE TERCERO", "PAGO CUENTA DE TERCERO"], 65),
    ("Pago por SPEI enviado (generico)", "PAGO_PROVEEDOR_CFDI", "cargo", 96,
     ["ENVIO SPEI", "SPEI ENVIADO"], 60),
