...
REGLAS = [
    ...
    ("Pago a proveedor por SPEI con factura", "PAGO_PROVEEDOR_CFDI", "cargo", 75,
     ["SPEI:FACT", "SPEIFACT", "SPEI:-FACT", "SPEL:FACT", "SPELFACT",
      "SPEI:PAGO", "SPEIPAGO", "SPEI:NOTA", "SPEINOTA", "SPEI:COTIZACION",
      "SPEI:ENVIO", "PAGO DE SERVICIO", "RETIRO POR DOMICILIACION"], 80),
