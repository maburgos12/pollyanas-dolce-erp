...
urlpatterns = [
    ...
    path("tendencias/", views.VentasTendenciasView.as_view(), name="tendencias"),
    ...
    path("eventos/<int:event_id>/exportar-produccion.xlsx", views.EventoExportProduccionView.as_view(), name="evento_export_produccion"),
    path("eventos/<int:event_id>/exportar-insumos.xlsx", views.EventoExportInsumosView.as_view(), name="evento_export_insumos"),
    path("eventos/<int:event_id>/tab/produccion/", views.EventoTabProduccionView.as_view(), name="evento_tab_produccion"),
    path("eventos/<int:event_id>/tab/proyeccion/", views.EventoTabProyeccionView.as_view(), name="evento_tab_proyeccion"),
    path("eventos/<int:event_id>/tab/insumos/", views.EventoTabInsumosView.as_view(), name="evento_tab_insumos"),
    path("eventos/<int:event_id>/tab/trazabilidad/", views.EventoTabTrazabilidadView.as_view(), name="evento_tab_trazabilidad"),
