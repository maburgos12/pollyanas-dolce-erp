...
- Entrega la cámara del dispositivo a los campos de evidencia `capture="environment"`.
- Abre los enlaces `tel:` de domicilios en el marcador del teléfono sin abandonar la sesión del ERP.
