...
urlpatterns = [
    ...
    path("costeo/simulador/insumos/search.json", views.costeo_simulador_insumos_search, name="costeo_simulador_insumos_search"),
    path("costeo/simulador/borradores/guardar/", views.costeo_simulador_draft_save, name="costeo_simulador_draft_save"),
