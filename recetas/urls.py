...
urlpatterns = [
    ...
    path("plan-produccion/api/guardar-borrador/", views.api_guardar_borrador, name="plan_guardar_borrador"),
    path("plan-produccion/api/calcular-bom/", views.api_calcular_bom, name="plan_calcular_bom"),
    path("plan-produccion/api/liberar/", views.api_liberar_plan, name="plan_liberar"),
    path("plan-produccion/api/demanda-sugerida/", views.api_demanda_sugerida, name="plan_demanda_sugerida"),
    path("plan-produccion/api/estado-hoy/", views.api_estado_hoy, name="plan_estado_hoy"),
