...
urlpatterns = [
    ...
    path("cumpleanos/", views_cumpleanos.calendario_cumpleanos, name="rrhh_cumpleanos"),
    ...
    path("incapacidades/", views_incapacidades.rrhh_incapacidades, name="rrhh_incapacidades"),
    path("incapacidades/crear/", views_incapacidades.crear_incapacidad, name="rrhh_incapacidad_crear"),
    path(
        "incapacidades/<int:incapacidad_id>/cancelar/",
    ...
    path(
        "incapacidades/<int:incapacidad_id>/eliminar/",
        views_incapacidades.eliminar_incapacidad,
        name="rrhh_incapacidad_eliminar",
    ),
