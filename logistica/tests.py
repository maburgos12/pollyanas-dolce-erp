...
'''
    ...
    def test_guardrail_exige_version_recarga_point_en_registro_y_service_worker(self):
        ...
        self.assertEqual(
            ...
            {"route-control-v86-indicadores-abasto"},
        )
        self.assertIn("pollyanas-logistica-pwa-v86-indicadores-abasto", REQUIRED_SERVICE_WORKER_MARKERS)
...
class LogisticaControlRutasTests(TestCase):
    ...
    def test_pwa_tracking_declara_cola_offline_reintento_y_cache_versionado(self):
        ...
        self.assertIn("?v=route-control-v86-indicadores-abasto", pwa_html)
        self.assertIn('scope: "/logistica/"', pwa_html)
        self.assertIn("pollyanas-logistica-pwa-v86-indicadores-abasto", sw_js)
    ...
    def test_pwa_sw_se_sirve_sin_cache_de_borde(self):
        ...
        self.assertIn("pollyanas-logistica-pwa-v86-indicadores-abasto", response.content.decode("utf-8"))
    ...
    def test_pwa_captura_sumatoria_y_contrae_desglose_por_sucursal(self):
        ...
        self.assertIn("route-control-v86-indicadores-abasto", pwa_html)
