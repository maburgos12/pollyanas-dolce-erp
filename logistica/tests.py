...
'''
    ...
    def test_guardrail_exige_version_recarga_point_en_registro_y_service_worker(self):
        ...
        self.assertEqual(
            ...
            {"route-control-v67-totales-claros"},
        )
...
class LogisticaControlRutasTests(TestCase):
    ...
    def test_pwa_tracking_declara_cola_offline_reintento_y_cache_versionado(self):
        ...
        self.assertIn("?v=route-control-v67-totales-claros", pwa_html)
    ...
    def test_pwa_captura_sumatoria_y_contrae_desglose_por_sucursal(self):
        ...
        self.assertIn("Enviado en Point ${totalProducto.esperado.toFixed(3)}", pwa_html)
        self.assertIn("Total cargado físico", pwa_html)
        self.assertIn("Diferencia física", pwa_html)
        self.assertNotIn("· cargar ${totalProducto.esperado.toFixed(3)}", pwa_html)
        ...
        self.assertIn("route-control-v67-totales-claros", pwa_html)
