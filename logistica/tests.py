...
'''
    ...
    def test_guardrail_exige_version_recarga_point_en_registro_y_service_worker(self):
        ...
        self.assertEqual(
            ...
            {"route-control-v90-inspeccion-sin-repetidos"},
        )
        self.assertIn("pollyanas-logistica-pwa-v90-inspeccion-sin-repetidos", REQUIRED_SERVICE_WORKER_MARKERS)
...
class LogisticaControlRutasTests(TestCase):
    ...
    def test_pwa_tracking_declara_cola_offline_reintento_y_cache_versionado(self):
        ...
        self.assertIn("?v=route-control-v90-inspeccion-sin-repetidos", pwa_html)
        self.assertIn('scope: "/logistica/"', pwa_html)
        self.assertIn("pollyanas-logistica-pwa-v90-inspeccion-sin-repetidos", sw_js)
    ...
    def test_pwa_sw_se_sirve_sin_cache_de_borde(self):
        ...
        self.assertIn("pollyanas-logistica-pwa-v90-inspeccion-sin-repetidos", response.content.decode("utf-8"))
