...
'''
    ...
    def test_guardrail_exige_version_recarga_point_en_registro_y_service_worker(self):
        ...
        self.assertEqual(
            ...
            {"route-control-v83-android-paridad"},
        )
        self.assertIn("pollyanas-logistica-pwa-v83-android-paridad", REQUIRED_SERVICE_WORKER_MARKERS)
...
class LogisticaControlRutasTests(TestCase):
    ...
    def test_pwa_tracking_declara_cola_offline_reintento_y_cache_versionado(self):
        ...
        self.assertIn("?v=route-control-v83-android-paridad", pwa_html)
        self.assertIn('scope: "/logistica/"', pwa_html)
        self.assertIn("pollyanas-logistica-pwa-v83-android-paridad", sw_js)
    ...
    def test_pwa_sw_se_sirve_sin_cache_de_borde(self):
        ...
        self.assertIn("pollyanas-logistica-pwa-v83-android-paridad", response.content.decode("utf-8"))
    ...
    def test_pwa_captura_sumatoria_y_contrae_desglose_por_sucursal(self):
        ...
        self.assertIn("route-control-v83-android-paridad", pwa_html)
