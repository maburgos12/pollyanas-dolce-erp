...
'''
    ...
    def test_guardrail_exige_version_recarga_point_en_registro_y_service_worker(self):
        ...
        self.assertEqual(
            ...
            {"route-control-v87-indicadores-reconciliables"},
        )
        self.assertIn("pollyanas-logistica-pwa-v87-indicadores-reconciliables", REQUIRED_SERVICE_WORKER_MARKERS)
...
class LogisticaControlRutasTests(TestCase):
    ...
    def test_pwa_tracking_declara_cola_offline_reintento_y_cache_versionado(self):
        ...
        self.assertIn("?v=route-control-v87-indicadores-reconciliables", pwa_html)
        self.assertIn('scope: "/logistica/"', pwa_html)
        self.assertIn("pollyanas-logistica-pwa-v87-indicadores-reconciliables", sw_js)
    ...
    def test_pwa_sw_se_sirve_sin_cache_de_borde(self):
        ...
        self.assertIn("pollyanas-logistica-pwa-v87-indicadores-reconciliables", response.content.decode("utf-8"))
