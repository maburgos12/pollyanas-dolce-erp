...
urlpatterns = [
    ...
    path("indicadores-abasto/", views.indicadores_abasto, name="indicadores_abasto"),
    path("indicadores-abasto/exportar/", views.indicadores_abasto_export, name="indicadores_abasto_export"),
