...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v91-mensaje-error-turno": "versionado exacto del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v91-mensaje-error-turno": "cache versionado de la PWA",
