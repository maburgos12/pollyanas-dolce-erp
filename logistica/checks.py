...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v29": "versionado del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v29-profile-before-flush": "cache versionado de la PWA",
