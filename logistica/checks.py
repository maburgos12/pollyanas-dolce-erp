...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v16": "versionado del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v16-dashboard-ruta-compacta": "cache versionado de la PWA",
