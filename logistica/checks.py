...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v30": "versionado del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v30-entrega-directa": "cache versionado de la PWA",
