...
REQUIRED_TEMPLATE_MARKERS = {
    "inicio-turno-validacion": "versionado del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v8-inicio-turno-validacion": "cache versionado de la PWA",
