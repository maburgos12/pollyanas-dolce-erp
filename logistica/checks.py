...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v54": "versionado del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v54-finalizar-ruta": "cache versionado de la PWA",
