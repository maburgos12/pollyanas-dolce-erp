...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v79-entrega-administrativa": "versionado exacto del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v79-entrega-administrativa": "cache versionado de la PWA",
