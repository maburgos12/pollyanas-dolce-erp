...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v25": "versionado del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v25-paradas-cedis": "cache versionado de la PWA",
