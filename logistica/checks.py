...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v86-indicadores-abasto": "versionado exacto del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v86-indicadores-abasto": "cache versionado de la PWA",
