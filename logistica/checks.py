...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v63-carga-tramos-consolidada": "versionado exacto del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v63-carga-tramos-consolidada": "cache versionado de la PWA",
