...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v56": "versionado del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v56-error-operativo-detallado": "cache versionado de la PWA",
