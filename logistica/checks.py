...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v88-flota-gastos-completos": "versionado exacto del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v88-flota-gastos-completos": "cache versionado de la PWA",
