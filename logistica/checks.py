...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v89-turno-combustible-seguro": "versionado exacto del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v89-turno-combustible-seguro": "cache versionado de la PWA",
