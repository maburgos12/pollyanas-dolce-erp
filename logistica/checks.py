...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v24": "versionado del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v24-confirmar-entrega": "cache versionado de la PWA",
