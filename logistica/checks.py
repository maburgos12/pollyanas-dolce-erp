...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v84-iconografia-lucide": "versionado exacto del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v84-iconografia-lucide": "cache versionado de la PWA",
