...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v15": "versionado del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v15-dashboard-ruta": "cache versionado de la PWA",
