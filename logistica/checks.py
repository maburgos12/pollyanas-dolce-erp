...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v14": "versionado del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v14-carga-checklist": "cache versionado de la PWA",
