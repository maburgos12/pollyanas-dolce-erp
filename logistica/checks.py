...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v32": "versionado del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v32-entrega-sin-gps": "cache versionado de la PWA",
