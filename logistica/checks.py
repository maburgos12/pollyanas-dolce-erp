...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v87-indicadores-reconciliables": "versionado exacto del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v87-indicadores-reconciliables": "cache versionado de la PWA",
