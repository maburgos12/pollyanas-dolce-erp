...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v93-rutas-futuras": "versionado exacto del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v93-rutas-futuras": "cache versionado de la PWA",
