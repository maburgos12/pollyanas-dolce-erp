...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v31": "versionado del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v31-cedis-recarga": "cache versionado de la PWA",
