...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v12": "versionado del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v12-tracking-secure": "cache versionado de la PWA",
