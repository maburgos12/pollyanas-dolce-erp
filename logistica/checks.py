...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v28": "versionado del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v28-entrega-click": "cache versionado de la PWA",
