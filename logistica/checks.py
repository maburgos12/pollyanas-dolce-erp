...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v65-recarga-point": "versionado exacto del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v65-recarga-point": "cache versionado de la PWA",
