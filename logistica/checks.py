...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v78-gps-ruta-activa": "versionado exacto del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v78-gps-ruta-activa": "cache versionado de la PWA",
