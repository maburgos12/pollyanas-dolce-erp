...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v62-enviado-cero-banner": "versionado exacto del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v62-enviado-cero-banner": "cache versionado de la PWA",
