...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v81-tramo-carga-recarga": "versionado exacto del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v81-tramo-carga-recarga": "cache versionado de la PWA",
