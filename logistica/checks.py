...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v27": "versionado del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v27-entrega-visible": "cache versionado de la PWA",
