...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v49": "versionado del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v49-recarga-abre-carga": "cache versionado de la PWA",
