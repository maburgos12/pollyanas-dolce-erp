...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v22": "versionado del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v22-token-sesion": "cache versionado de la PWA",
