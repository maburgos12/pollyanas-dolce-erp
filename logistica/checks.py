...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v17": "versionado del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v17-recepcion-point": "cache versionado de la PWA",
