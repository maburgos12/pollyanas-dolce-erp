...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v11": "versionado del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v11-auto-tracking": "cache versionado de la PWA",
