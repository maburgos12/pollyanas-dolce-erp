...
REQUIRED_TEMPLATE_MARKERS = {
    "route-control-v23": "versionado del service worker para forzar actualizacion de la PWA",
}

REQUIRED_SERVICE_WORKER_MARKERS = {
    "pollyanas-logistica-pwa-v23-totales-carga": "cache versionado de la PWA",
