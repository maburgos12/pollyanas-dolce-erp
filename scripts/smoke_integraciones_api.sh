...
CMD=(.venv/bin/python manage.py smoke_integraciones_api --base-url "$BASE_URL" --timeout "$TIMEOUT")
...
#   ./scripts/smoke_integraciones_api.sh --live --confirm-live YES --idle-days 30 --idle-limit 10
CMD+=("$@")
