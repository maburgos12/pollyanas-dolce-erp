...
- API: GET /api/compras/solicitudes/ (listado de solicitudes con filtros, estatus y presupuesto estimado; soporta `limit`/`offset` y totales filtrados)
...
- API: GET /api/compras/ordenes/ (listado de órdenes con filtros y monto total estimado; soporta `limit`/`offset` y totales filtrados)
- API: GET /api/compras/recepciones/ (listado de recepciones con filtros y totales por estatus; soporta `limit`/`offset`)
