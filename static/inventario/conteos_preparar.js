(function () {
  ...
  var busy=false, catalogBranch=form.dataset.catalogBranch||'', states=new Map();
  ...
  if(form.elements.sucursal)form.elements.sucursal.addEventListener('change',function(){search.requestSubmit();});
  summary();
})();
