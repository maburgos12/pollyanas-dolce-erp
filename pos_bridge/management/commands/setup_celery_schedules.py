...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Syncfy eliminado (servicio de paga descartado): limpiar el schedule si existe.
        PeriodicTask.objects.filter(name="syncfy: sincronizacion bancaria nocturna").delete()
        ...
        PeriodicTask.objects.update_or_create(
            ...
            defaults={
                ...
                "interval": None,
                "kwargs": json.dumps({"lock_after_build": True}),
                "enabled": True,
            },
        )
