...
class HallmarkGuardrailsStaticTests(SimpleTestCase):
    ...
    def test_base_template_includes_mobile_touch_navigation_shell(self):
        ...
        self.assertIn("20260926-production-table-v2", html)
    ...
    def test_base_template_makes_erp_installable_as_pwa(self):
        ...
        self.assertIn("navigator.serviceWorker.register('/erp-sw.js?v=20260926-seguimiento-panel-tipos-v5')", html)
    ...
    def test_erp_pwa_manifest_and_service_worker_are_minimal(self):
        ...
        self.assertIn('const CACHE_NAME = "pollyanas-erp-shell-20260926-seguimiento-panel-tipos-v5";', sw)
        ...
        self.assertEqual(sw.encode(), b"".join(response.streaming_content))
