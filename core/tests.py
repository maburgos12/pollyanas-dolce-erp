...
class HallmarkGuardrailsStaticTests(SimpleTestCase):
    ...
    def test_base_template_includes_mobile_touch_navigation_shell(self):
        ...
        self.assertIn("20260704-badge-centering-v16", html)
    ...
    def test_base_template_makes_erp_installable_as_pwa(self):
        ...
        self.assertIn("navigator.serviceWorker.register('/erp-sw.js?v=20260722-seguimiento-dg-compact-v21')", html)
    ...
    def test_erp_pwa_manifest_and_service_worker_are_minimal(self):
        ...
        self.assertIn('const CACHE_NAME = "pollyanas-erp-shell-v21-seguimiento-dg-compact"', sw)
        ...
        self.assertIn(b"pollyanas-erp-shell-v21-seguimiento-dg-compact", b"".join(response.streaming_content))
