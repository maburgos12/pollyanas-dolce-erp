...
class UsersAccessTests(TestCase):
    ...
    def test_admin_can_open_users_access_page(self):
        ...
        self.assertContains(response, "Flujo operativo")
        self.assertContains(response, "RBAC por estado y rol")
        self.assertContains(response, "Autorización y auditoría")
        ...
        self.assertContains(response, "Permisos · compras_user")
