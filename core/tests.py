...
class HallmarkGuardrailsStaticTests(SimpleTestCase):
    ...
    def test_base_template_makes_erp_installable_as_pwa(self):
        ...
        self.assertIn("navigator.serviceWorker.register('/erp-sw.js?v=20260923-jornadas-semanales-v3')", html)
    ...
    def test_erp_pwa_manifest_and_service_worker_are_minimal(self):
        ...
        self.assertIn('const CACHE_NAME = "pollyanas-erp-shell-20260923-jornadas-semanales-v3";', sw)
