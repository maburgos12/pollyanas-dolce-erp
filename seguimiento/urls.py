...
urlpatterns = [
    ...
    path("panel/crear-agente-dg/", views.crear_acuerdo_agente_dg, name="crear_acuerdo_agente_dg"),
    ...
    path("calendario/actividades/", views.actividad_crear, name="actividad_crear"),
    path("calendario/actividades/<int:pk>/", views.actividad_editar, name="actividad_editar"),
    path("calendario/actividades/<int:pk>/completar/", views.actividad_completar, name="actividad_completar"),
    path("calendario/actividades/<int:pk>/eliminar/", views.actividad_eliminar, name="actividad_eliminar"),
