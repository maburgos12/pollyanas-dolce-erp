...
class OperacionAppTests(TestCase):
    ...
    def test_unified_app_home_exposes_django_logout(self):
        ...
        self.assertContains(response, "20260730-sales-catalog-live-v5")
        ...
        self.assertContains(response, 'navigator.serviceWorker.register("/app/sw.js?v=20260730-sales-catalog-live-v5"')
    ...
    def test_operational_app_serves_own_service_worker(self):
        ...
        self.assertIn("pollyanas-app-operativa-pwa-v30-sales-catalog-live", body)
...
class ResponsiveDesignAndContentTests(TestCase):
    ...
    def test_service_worker_version_updated_in_sw_js(self):
        ...
        self.assertIn("v30-sales-catalog-live", sw_content)
