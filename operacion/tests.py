...
class OperacionAppTests(TestCase):
    ...
    def test_unified_app_home_exposes_django_logout(self):
        ...
        self.assertContains(response, 'apple-mobile-web-app-status-bar-style" content="black-translucent"')
        ...
        self.assertContains(response, 'navigator.serviceWorker.register("/app/sw.js?v=20260708-mobile-polish-v4"')
