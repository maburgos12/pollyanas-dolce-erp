...
class OperacionAppTests(TestCase):
    ...
    def test_unified_app_home_exposes_django_logout(self):
        ...
        self.assertContains(response, "20260709-pull-refresh-v2")
        ...
        self.assertContains(response, 'navigator.serviceWorker.register("/app/sw.js?v=20260709-pull-refresh-v2"')
    ...
    def test_operational_app_serves_own_service_worker(self):
        ...
        self.assertIn("pollyanas-app-operativa-pwa-v13-pull-refresh-ios", body)
