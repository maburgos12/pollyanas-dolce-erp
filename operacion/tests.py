...
class OperacionAppTests(TestCase):
    ...
    def test_unified_app_home_exposes_django_logout(self):
        ...
        self.assertContains(response, "20260907-conteos-v11")
        ...
        self.assertContains(
            response,
            'navigator.serviceWorker.register("/app/sw.js?v=20260907-conteos-v11"',
        )
    ...
    def test_operational_app_serves_own_service_worker(self):
        ...
        self.assertIn("pollyanas-app-operativa-pwa-v37-conteos-sucursales", body)
...
class ResponsiveDesignAndContentTests(TestCase):
    ...
    def test_service_worker_version_updated_in_sw_js(self):
        ...
        self.assertIn("v37-conteos-sucursales", sw_content)
