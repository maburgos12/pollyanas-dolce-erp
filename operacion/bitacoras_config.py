...
CFP11_ITEMS = [
    ...
    producto("DAWN", "G", "Pan de Vainilla Dawn Grande", "Dawn Grande"),
    producto("DAWN", "MINI", "Pan de Vainilla Dawn Mini", "Dawn Mini"),
    producto("FLAN 3 PECADOS", "CH", "Flan 3 Pecados Chico"),
    producto("FLAN 3 PECADOS", "M", "Flan 3 Pecados Mediano"),
    producto("FLAN 3 PECADOS", "G", "Flan 3 Pecados Grande"),
    producto("FLAN 3 PECADOS", "MINI", "Flan 3 Pecados Mini", "Flan 3 Pecados Individual"),
    producto("CHOCOLATE", "CH", "Pan Chocolate Chico", "Pan de Chocolate Chico"),
    producto("CHOCOLATE", "M", "Pan Chocolate Mediano", "Pan de Chocolate Mediano"),
    producto("CHOCOLATE", "G", "Pan Chocolate Grande", "Pan de Chocolate Grande"),
    producto("CHOCOLATE", "MINI", "Pan Chocolate Mini", "Pan de Chocolate Mini"),
    producto("3 LECHES", "", "Pastel 3 Leches", "3 Leches"),
    producto("TARTA PARA PAY", "", "Tarta para Pay"),
    producto("TARTA CON NUEZ", "", "Tarta con Nuez"),
    producto("PAY DE QUESO", "", "Pay de Queso"),
    producto("PAY HORNEADO", "", "Pay Horneado"),
    producto("BOLLO", "", "Bollo"),
    producto("CHEESECAKE", "", "CheeseCake"),
    producto("BROWNIE", "", "Brownie"),
]
...
BITACORA_CONFIG = {
    ...
    BitacoraOperativa.TIPO_CFP11: {
        ...
        "ayuda": "Captura entrada, salida y existencia final para conciliar contra el día anterior.",
        "familia": "daily_product",
        "campos": ["entrada", "salida", "existencia_final"],
        "mostrar_inicial_esperado": True,
        "items": CFP11_ITEMS,
    },
    ...
    BitacoraOperativa.TIPO_HORNOS: {
        ...
        "ayuda": "Corte a ciegas: existencia inicial y preparación producida en el día.",
        "familia": "weekly_matrix",
        "campos": ["existencia", "preparacion"],
        "referencias_jefatura": ["stock", "proyeccion"],
        "items": HORNO_ITEMS,
    },
    BitacoraOperativa.TIPO_ARMADO: {
        "titulo": "Control producción - Armado",
        "ayuda": "Corte a ciegas: existencia inicial y preparación armada en el día.",
        "familia": "weekly_matrix",
        "campos": ["existencia", "preparacion"],
        "referencias_jefatura": ["stock", "proyeccion"],
        "items": ARMADO_ITEMS,
